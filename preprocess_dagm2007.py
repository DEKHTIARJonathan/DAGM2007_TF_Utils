...
parser.add_argument(
    ...
    required=True,
    type=str,
    help="Path to DAGM 2007 private dataset"
)
...
if __name__ == "__main__":
    ...
    for challenge_id in range(10):
        ...
        for data_set in ["Train", "Test"]:
            ...
            with open(os.path.join(challenge_folder_path, "%s_list.txt" % data_set.lower()), 'w') as data_list_file:
                ...
                if DEFECTIVE_COUNT[data_set][challenge_id + 1] != EXPECTED_DEFECTIVE_SAMPLES_PER_CLASS[data_set][challenge_id + 1]:
